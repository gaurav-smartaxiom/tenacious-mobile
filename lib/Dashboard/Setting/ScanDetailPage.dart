...
class DeviceDetailPage1 extends StatefulWidget {
  
  final String deviceId;
  DeviceDetailPage1({required this.deviceId});
...
class _DeviceDetailPageState extends State<DeviceDetailPage1> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Device Detail Page'),
      ),
      body: Center(
        child: Column(
  ...
  // Method to handle the logic when "Start DFU" button is pressed
  void startDFU() {
  // Add your DFU logic here
  print("Start DFU button pressed!");

  // Pass the deviceid to the DFUUpdateScreen
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => DFUUpdateScreen(deviceId: widget.deviceId),
    ),
  );
}
